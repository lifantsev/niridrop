...
Note that the script optionally depends on [lg logging utils](https://github.com/lifantsev/lg). If you don't want to install them, remove calls to `lga` and `lge`.
